<template>
  <div>
      ...
      <div class="section">
          <h1 class="title has-text-centered">Datos Basicos</h1>
          <div class="box">
            <div class="field">
              <label for="banco" class="label">Bancos</label>
              <div class="select">
            ...
            <div class="field">
              <label for="name" class="label">Cuenta Bancaria</label>
              <div class="control">
            ...
            <div class="control has-text-centered">
              <div class="button is-info">Guardar Datos Bancarios</div>
            </div>
          </div>
        </div>
...
<script>
import Header from '../GameComponents/GameHeader'
